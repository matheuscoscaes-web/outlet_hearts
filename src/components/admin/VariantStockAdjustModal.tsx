...
export default function VariantStockAdjustModal({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch(`/api/admin/stock/variant/${variantId}`, {
      method: "PATCH",
  ...
  return (
    <>
      <button
        ...
        className="rounded-lg border border-gray-200 p-1 text-gray-500 hover:bg-amber-50 hover:border-amber-300 hover:text-amber-700"
